        ...
        <div id="login-box">
            ...
            <form method="post" action="{{ route('action-register') }}">
                ...
                <div class="form-group controls">
                    ...
                    <input class="form-control" type="text" name="alamat" placeholder="Alamat" required value="{{ old('alamat') }}">
                </div>
                ...
                <hr>
                <p class="text-center">
                    Sudah punya akun? <a href="{{ route('login') }}" style="color: #ff5252;">Login disini</a>
                </p>
            </form>
        </div>
    </div>
